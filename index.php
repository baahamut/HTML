...
if (isset($_POST['connexion']) && $_POST['connexion'] == 'Connexion') {
	...
	$sql = 'SELECT count(*) FROM membre WHERE login="'.mysql_real_escape_string($_POST['login']).'" AND pass="'.mysql_real_escape_string(md5($_POST['pass'])).'"';
								...
								<li data-transition="slidedown" data-slotamount="10" data-masterspeed="300">
									<img src="img/slides/slide-bg.jpg" data-fullwidthcentering="on" alt="">
										...
										<div class="caption top-label lfl stl"
											 ...
											 data-speed="300"
											 data-start="500"
											 data-easing="easeOutExpo">Quelque chose à vendre?</div>
										...
										<div class="caption main-label sft stb"
											 ...
											 data-speed="300"
											 data-start="1500"
											 data-easing="easeOutExpo"> <a href="http://www.google.fr" alt""> Cadeaux? </a></div>
										...
										<div class="caption bottom-label sft stb"
											 ...
											 data-speed="500"
											 data-start="2000"
											 data-easing="easeOutExpo">Regardez ce qui se vend à côté de chez vous!</div>
										...
										<div class="caption fade"
											 ...
											 data-speed="500"
											 data-start="2500"
											 data-easing="easeOutExpo"><img src="img/slides/slide1.png" alt="Iphone"></div>
								...
								<li data-transition="slidedown" data-slotamount="10" data-masterspeed="300">
									<img src="img/slides/slide-bg.jpg" data-fullwidthcentering="on" alt="">
										...
										<div class="caption fade"
											 ...
											 data-speed="500"
											 data-start="200"
											 data-easing="easeOutExpo"><img src="img/slides/slide2.png" alt=""></div>
										...
										<div class="caption main-label sft stb"
											 ...
											 data-speed="300"
											 data-start="1500"
											 data-easing="easeOutExpo">Créez un compte</div>
										...
										<div class="caption bottom-label sft stb"
											 ...
											 data-speed="500"
											 data-start="2000"
											 data-easing="easeOutExpo">...en 3 clics et faites parti de la communauté</div>
								...
								<li data-transition="slidedown" data-slotamount="10" data-masterspeed="300">
									<img src="img/slides/slide-bg.jpg" data-fullwidthcentering="on" alt="">
										...
										<div class="caption fade"
											 ...
											 data-speed="500"
											 data-start="200"
											 data-easing="easeOutExpo"><img src="img/slides/slide3.jpg" alt="slide3"></div>
										...
										<div class="caption main-label sft stb"
											 ...
											 data-speed="300"
											 data-start="1500"
											 data-easing="easeOutExpo">1. Je crée mon affaire</div>
										...
										<div class="caption main-label sft stb"
											 ...
											 data-speed="300"
											 data-start="2000"
											 data-easing="easeOutExpo">2. j'ajoute mes articles</div>
										...
										<div class="caption main-label sft stb"
											 ...
											 data-speed="300"
											 data-start="2500"
											 data-easing="easeOutExpo">3. Je lance mon affaire</div>
