...
?>
	...
	<body>
		...
		<div class="body">
			...
			<form action="gerer.php" method="post">
				...
				Titre de votre annonce (max.50 caractères): <input type="text" name="ann_title" value="<?php if (isset($_POST['ann_title'])) echo htmlentities(trim($_POST['ann_title'])); ?>"><br />
				Description de votre article (max. 255 caractères) : <input type="text" name="ann_description" value="<?php if (isset($_POST['ann_description'])) echo htmlentities(trim($_POST['ann_description'])); ?>"><br />
				Prix (€): <input type="text" name="ann_prix" value="<?php if (isset($_POST['ann_prix'])) echo htmlentities(trim($_POST['ann_prix'])); ?>"><br />
				Catégories: <input type="text" name="ann_categorie" value="<?php if (isset($_POST['ann_categorie'])) echo htmlentities(trim($_POST['ann_categorie'])); ?>"><br />    
	<!--<FORM>
	...
	Fichier (tous formats | max. 3 Mo) : <br />
